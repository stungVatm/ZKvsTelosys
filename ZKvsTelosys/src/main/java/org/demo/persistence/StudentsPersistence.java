...
/**
 * Persistence Interface for StudentsRecord.
 */
public interface StudentsPersistence { 
	 ...
	 * @return entity
	 */
	StudentsRecord save(StudentsRecord entity);
	 ...
	 */
	boolean update(StudentsRecord entity);
	 ...
	 * @return
	 */
	StudentsRecord create(StudentsRecord entity);
	 ...
	 * @return true if the entity has been deleted, false if not found and not deleted
	 */
	boolean delete( StudentsRecord entity );
	 ...
	 * @return
	 */
	public boolean exists( StudentsRecord entity ) ;
