...
/**
 * Persistence Interface for ScoresRecord.
 */
public interface ScoresPersistence { 
	 ...
	 * @return entity
	 */
	ScoresRecord findById( Integer id  ) ;

	/**
	 * Finds all entities.
	 * @return all entities
	 */
	List<ScoresRecord> findAll();
	 ...
	 * @return entity
	 */
	ScoresRecord save(ScoresRecord entity);
	 ...
	 */
	boolean update(ScoresRecord entity);
	 ...
	 * @return
	 */
	ScoresRecord create(ScoresRecord entity);
	 ...
	 * @return true if the entity has been deleted, false if not found and not deleted
	 */
	boolean delete( ScoresRecord entity );
	 ...
	 * @return
	 */
	public boolean exists( ScoresRecord entity ) ;
